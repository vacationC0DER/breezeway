...
ENTITY_CONFIGS = {
    'properties': {
        ...
        'no_update_columns': ['property_status'],  # webhook-owned; poll sets on INSERT only
...
# ── Reference entities (2026-06-23) — full Breezeway public-endpoint coverage.
# Per-region (per-company) plain lists; same shape as `tags`/`supplies`.
ENTITY_CONFIGS.update({
    'subdepartments': {
        'endpoint': '/companies/subdepartments',
        'api_id_field': 'id',
    ...
    'property_tags': {
        'endpoint': '/property/tags',
        'api_id_field': 'id',
        'table_name': 'property_tags',
        'natural_key': ['property_tag_id', 'region_code'],
        'supports_incremental': False,
        'fields_mapping': {
            'id': 'property_tag_id',
            'name': 'tag_name',
    ...
    'reservation_tags': {
        'endpoint': '/reservation/tags',
        'api_id_field': 'id',
        'table_name': 'reservation_tags',
        'natural_key': ['reservation_tag_id', 'region_code'],
        'supports_incremental': False,
        'fields_mapping': {
